...
@section('content')
    <div data-page="problems">
        <x-page-introduction eyebrow="Problems We Investigate" title="Where is the work getting harder than it needs to be?">
            ...
            <x-slot:actions>
                <a class="button button-primary" href="{{ route('digital-friction-audit') }}" data-cta-location="problems-hero">Request a Digital Friction Audit</a>
