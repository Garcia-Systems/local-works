            ...
            <div class="site-container section-space">
                ...
                <div class="mt-12 grid items-start gap-10 lg:grid-cols-[1.25fr_.75fr] lg:gap-12">
                    <div class="audit-form-surface">
                        <div id="form-availability" class="form-notice" role="note"><strong>Intake preview</strong><span>The form is ready to review, but requests are not being submitted or stored yet. Submission will be enabled with the privacy-conscious request process.</span></div>
                        <form class="audit-form mt-8" action="#audit-intake" onsubmit="return false" aria-describedby="form-availability privacy-note" data-audit-intake data-analytics-form="audit-request">
                            <fieldset><legend>Contact</legend><p class="form-group-help">How we can identify and eventually reply to you.</p><div class="form-grid mt-6">
                                <div class="field sm:col-span-2"><label for="name">Name <span aria-hidden="true">*</span><span class="sr-only"> (required)</span></label><input id="name" name="name" type="text" autocomplete="name" required aria-required="true" aria-describedby="name-help"><p id="name-help">Your full name.</p></div>
                                <div class="field"><label for="email">Email <span aria-hidden="true">*</span><span class="sr-only"> (required)</span></label><input id="email" name="email" type="email" inputmode="email" autocomplete="email" required aria-required="true" aria-describedby="email-help"><p id="email-help">A work or personal email you check.</p></div>
                                <div class="field"><label for="phone">Phone <span class="field-status">Optional</span></label><input id="phone" name="phone" type="tel" inputmode="tel" autocomplete="tel" aria-describedby="phone-help"><p id="phone-help">Include it only if a call is convenient.</p></div>
                            </div></fieldset>
                            <fieldset><legend>Business</legend><p class="form-group-help">A little context about the organization and its setting.</p><div class="form-grid mt-6">
                                <div class="field sm:col-span-2"><label for="business_name">Business name <span aria-hidden="true">*</span><span class="sr-only"> (required)</span></label><input id="business_name" name="business_name" type="text" autocomplete="organization" required aria-required="true" aria-describedby="business-name-help"><p id="business-name-help">The organization connected to the workflow.</p></div>
                                <div class="field"><label for="business_website">Business website <span class="field-status">Optional</span></label><input id="business_website" name="business_website" type="url" inputmode="url" autocomplete="url" aria-describedby="website-help"><p id="website-help">A public URL, if one is useful.</p></div>
                                <div class="field"><label for="business_type">Type of business <span class="field-status">Optional</span></label><input id="business_type" name="business_type" type="text" autocomplete="organization-title" aria-describedby="type-help"><p id="type-help">For example, membership or local service business.</p></div>
                                <div class="field sm:col-span-2"><label for="location">Location <span class="field-status">Optional</span></label><input id="location" name="location" type="text" autocomplete="address-level2" aria-describedby="location-help"><p id="location-help">City or service area is enough.</p></div>
                            </div></fieldset>
                            <fieldset><legend>Workflow</legend><p class="form-group-help">Plain language is best. You do not need to propose a solution.</p><div class="form-grid mt-6">
                                <div class="field sm:col-span-2"><label for="friction">What are customers or employees having trouble doing? <span aria-hidden="true">*</span><span class="sr-only"> (required)</span></label><textarea id="friction" name="friction" rows="5" required aria-required="true" aria-describedby="friction-help"></textarea><p id="friction-help">Describe the task or moment that feels harder than it should.</p></div>
                                <div class="field sm:col-span-2"><label for="current_process">How is that process handled today? <span aria-hidden="true">*</span><span class="sr-only"> (required)</span></label><textarea id="current_process" name="current_process" rows="5" required aria-required="true" aria-describedby="process-help"></textarea><p id="process-help">Tell us the main steps, people, or tools involved as best you know them.</p></div>
                                <div class="field sm:col-span-2"><label for="desired_improvement">What would you like to improve? <span class="field-status">Optional</span></label><textarea id="desired_improvement" name="desired_improvement" rows="4" aria-describedby="improvement-help"></textarea><p id="improvement-help">Focus on the experience or burden, not a particular technology.</p></div>
                                <div class="field sm:col-span-2"><label for="additional_context">Anything else we should know? <span class="field-status">Optional</span></label><textarea id="additional_context" name="additional_context" rows="4" aria-describedby="context-help"></textarea><p id="context-help">Add relevant context only. Detailed system access is not needed.</p></div>
                            </div></fieldset>
                            <p id="privacy-note" class="privacy-note">Information will be used to evaluate and respond to the request once submission is enabled. Do not include passwords or highly sensitive information. Detailed system access is not required at this stage. Read the <a href="{{ route('privacy') }}">privacy notice</a>.</p>
                            <button class="button button-primary w-full sm:w-auto" type="submit" disabled aria-describedby="form-availability" data-analytics-submit="audit-request">Request submission coming next</button>
                        </form>
                    </div>
